...
export default function Login() {
  ...
  // CRITICAL: onClick must be a plain function, NOT async
  // signInWithPopup must be called synchronously from the click event
  const handleSignIn = () => {
    if (signingIn) return;
    setSigningIn(true);
    setAuthError(null);
        ...
        <div className="space-y-4 self-start">
          <div className="bg-white/10 backdrop-blur rounded-xl p-3 text-sm text-white w-72 animate-float">
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="shrink-0 text-xs bg-amber-400/20 text-amber-100 px-2 py-0.5 rounded-full">In Progress</span>
            </div>
          </div>
          <div className="bg-white/10 backdrop-blur rounded-xl p-3 text-sm text-white w-72 animate-float-delayed">
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="shrink-0 text-xs bg-emerald-400/20 text-emerald-100 px-2 py-0.5 rounded-full">Complete</span>
            </div>
          </div>
          <div className="bg-white/10 backdrop-blur rounded-xl p-3 text-sm text-white w-72">
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="shrink-0 text-xs bg-sky-400/20 text-sky-100 px-2 py-0.5 rounded-full">Planned</span>
            </div>
          </div>
        </div>
      </section>
            ...
            {signingIn ? (
              ...
              <>
                <svg width="20" height="20" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                  <path fill="#FFC107" d="M43.611 20.083H42V20H24v8h11.303C33.02 32.737 28.815 36 24 36c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.938 3.043l5.657-5.657C34.047 6.053 29.268 4 24 4 12.955 4 4 12.955 4 24s8.955 20 20 20 20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z" />
                  <path fill="#FF3D00" d="M6.306 14.691l6.571 4.819C14.655 16.108 18.991 12 24 12c3.059 0 5.842 1.154 7.938 3.043l5.657-5.657C34.047 6.053 29.268 4 24 4c-7.682 0-14.318 4.26-17.694 10.691z" />
                  <path fill="#4CAF50" d="M24 44c5.166 0 9.86-1.977 13.409-5.197l-6.191-5.238C29.211 35.091 26.715 36 24 36c-4.798 0-8.994-3.246-10.303-7.651l-6.522 5.025C10.505 39.556 16.772 44 24 44z" />
                  <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-1.1 2.948-3.47 5.401-6.585 6.565l6.191 5.238C36.925 37.834 44 32.5 44 24c0-1.341-.138-2.65-.389-3.917z" />
                </svg>
